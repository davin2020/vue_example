const appCruise = Vue.createApp({
    data() {
        return {
            productName: 'Book a Trip to Leith',
            productDescription: 'Take a break from the smog of Westerley and book a trip to the verdant moon Leith, aboard Lucy the Spaceship. Watch the Killjoys in action as you leave the smog of Westerley behind.',
